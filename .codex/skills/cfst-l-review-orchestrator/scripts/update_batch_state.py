#!/usr/bin/env python3
"""Update one paper entry inside l_review_batch_state.json."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Update one paper entry in l_review_batch_state.json.")
    parser.add_argument("--batch-state", type=Path, required=True, help="Path to l_review_batch_state.json.")
